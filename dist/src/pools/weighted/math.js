...
const _calcOutGivenIn = (balanceIn, weightIn, balanceOut, weightOut, amountIn, options) => {
    /*****************************************************************************************
    // outGivenIn                                                                           //
    // ao = amountOut                                                                       //
    // bo = balanceOut                                                                      //
    ...
    *****************************************************************************************/
    ...
    if (options) {
        ...
        amountIn = (0, big_number_1.scale)(scaledAmountInWithoutFees, scalingFactor);
    }
...
// current balances and weights.
const _calcInGivenOut = (balanceIn, weightIn, balanceOut, weightOut, amountOut, options) => {
    /*****************************************************************************************
    // inGivenOut                                                                           //
    // ao = amountOut                                                                       //
    // bo = balanceOut                                                                      //
