...
// The amplification parameter equals: A n^(n-1)
const _calcOutGivenIn = (amplificationParameter, balances, tokenIndexIn, tokenIndexOut, tokenAmountIn, options) => {
    /**************************************************************************************************************
    ...
    **************************************************************************************************************/
    ...
    if (options) {
        ...
        const scaledAmountIn = (0, big_number_1.scale)(tokenAmountIn, -scalingFactor);
        const scaledAmountInWithoutFees = fp.sub(scaledAmountIn, fp.mulUp(scaledAmountIn, options.swapFeePercentage));
        tokenAmountIn = (0, big_number_1.scale)(scaledAmountInWithoutFees, scalingFactor);
    }
...
// The amplification parameter equals: A n^(n-1)
const _calcInGivenOut = (amplificationParameter, balances, tokenIndexIn, tokenIndexOut, tokenAmountOut, options) => {
    /**************************************************************************************************************
    ...
    **************************************************************************************************************/
    ...
    if (options) {
        ...
        const scalingFactor = 18 - options.tokenInDecimals;
        const scaledAmountIn = (0, big_number_1.scale)(amountIn, -scalingFactor);
        const scaledAmountInWithFees = fp.divUp(scaledAmountIn, fp.sub(fp.ONE, options.swapFeePercentage));
        amountIn = (0, big_number_1.scale)(scaledAmountInWithFees, scalingFactor);
    }
    return amountIn;
};
