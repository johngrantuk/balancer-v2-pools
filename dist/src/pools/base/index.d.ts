...
export default abstract class BasePool {
    ...
    protected _subtractSwapFeeAmount(amount: BigNumber | string, decimals: number): BigNumber;
    protected _addSwapFeeAmount(amount: BigNumber | string, decimals: number): BigNumber;
}
